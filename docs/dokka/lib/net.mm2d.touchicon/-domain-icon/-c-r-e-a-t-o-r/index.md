[lib](../../../index.md) / [net.mm2d.touchicon](../../index.md) / [DomainIcon](../index.md) / [CREATOR](./index.md)

# CREATOR

`companion object CREATOR : `[`Creator`](https://developer.android.com/reference/android/os/Parcelable/Creator.html)`<`[`DomainIcon`](../index.md)`>`
