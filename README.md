...
dependencies {
    implementation 'net.mm2d:touchicon:0.6.2'
    implementation 'net.mm2d:touchicon-http-okhttp:0.6.2' // If use OkHttp for HTTP access
    implementation 'net.mm2d:touchicon-html-jsoup:0.6.2'  // If use Jsoup for HTML parse
}
```
