 ...
 */
internal fun makeAbsoluteUrl(baseUrl: String, url: String): String = when {
...
private fun makePath(baseUrl: String, url: String): String {
    ...
    return if (pos > 0) basePath.substring(0, pos + 1) + url else url
}
...
internal fun String.normalizePath(): String {
    ...
    while (iterator.hasNext()) {
        ...
        iterator.remove()
        require(iterator.hasPrevious()) { "path traversal error: $this" }
        iterator.previous()
        iterator.remove()
    }
